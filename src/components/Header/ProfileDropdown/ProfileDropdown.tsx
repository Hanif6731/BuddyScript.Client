...
const ProfileDropdown: React.FC<ProfileDropdownProps> = ({ show }) => {
    ...
    return (
        <div id="_prfoile_drop" className={`_nav_profile_dropdown _profile_dropdown ${show ? 'show' : ''}`}>
            <div className="_nav_profile_dropdown_info">
                <div className="_nav_profile_dropdown_image">
                    <div className="_nav_drop_img" style={{
                        borderRadius: '50%',
                ...
                <div className="_nav_profile_dropdown_info_txt">
                    <h4 className="_nav_dropdown_title">{fullName || 'Loading...'}</h4>
            ...
            <ul className="_nav_dropdown_list">
                ...
                <li className="_nav_dropdown_list_item">
                    <div className="_nav_dropdown_link" style={{ cursor: 'pointer' }} onClick={handleLogout}>
                        <div className="_nav_drop_info">
                            <span>
