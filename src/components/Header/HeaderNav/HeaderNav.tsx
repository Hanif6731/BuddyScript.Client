...
import { headerNavReducer, initialState } from './HeaderNav.reducer';
import { toggleNotifications } from './HeaderNav.actions';
import NotificationDropdown from '../NotificationDropdown/NotificationDropdown';

const HeaderNav: React.FC = () => {
    const [state, dispatch] = useReducer(headerNavReducer, initialState);
    ...
    return (
        <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
            ...
            <li className="nav-item _header_nav_item" id="_notify_parent">
                <span 
                    id="_notify_btn" 
                    className={`nav-link _header_nav_link _header_notify_btn ${state.isNotificationsOpen ? 'show' : ''}`}
                ...
                >
                    ...
                    {state.isNotificationsOpen && <NotificationDropdown />}
                </span>
            </li>
            <li className="nav-item _header_nav_item">
