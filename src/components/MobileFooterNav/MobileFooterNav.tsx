...
import { mobileFooterNavReducer, initialState } from './MobileFooterNav.reducer';
import { setActiveTab } from './MobileFooterNav.actions';

const MobileFooterNav: React.FC = () => {
    const [state, dispatch] = useReducer(mobileFooterNavReducer, initialState);
                        ...
                        <div className="col-xl-12 col-lg-12 col-md-12">
                            <ul className="_mobile_navigation_bottom_list">
                                <li className="_mobile_navigation_bottom_item">
                                    <a 
                                        href="feed.html" 
                                        className={`_mobile_navigation_bottom_link ${state.activeTab === 'feed' ? '_mobile_navigation_bottom_link_active' : ''}`}
                                        onClick={(e) => { e.preventDefault(); handleTabClick('feed'); }}
                                    >
                                ...
                                <li className="_mobile_navigation_bottom_item">
                                    <a 
                                        ...
                                        className={`_mobile_navigation_bottom_link ${state.activeTab === 'friends' ? '_mobile_navigation_bottom_link_active' : ''}`}
                                        onClick={(e) => { e.preventDefault(); handleTabClick('friends'); }}
                                    >
                                ...
                                <li className="_mobile_navigation_bottom_item">
                                    <a 
                                        href="#0" 
                                        className={`_mobile_navigation_bottom_link ${state.activeTab === 'notifications' ? '_mobile_navigation_bottom_link_active' : ''}`}
                                        onClick={(e) => { e.preventDefault(); handleTabClick('notifications'); }}
                                    >
                                ...
                                <li className="_mobile_navigation_bottom_item">
                                    <a 
                                        ...
                                        className={`_mobile_navigation_bottom_link ${state.activeTab === 'chat' ? '_mobile_navigation_bottom_link_active' : ''}`}
                                        onClick={(e) => { e.preventDefault(); handleTabClick('chat'); }}
                                    >
