...
import { themeSwitcherReducer, initialState } from './ThemeSwitcher.reducer';
import { toggleTheme as toggleThemeAction } from './ThemeSwitcher.actions';

const ThemeSwitcher: React.FC = () => {
    const { toggleTheme } = useTheme();
    const [, dispatch] = useReducer(themeSwitcherReducer, initialState);
