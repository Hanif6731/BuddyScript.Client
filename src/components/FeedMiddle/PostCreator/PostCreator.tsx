...
const PostCreator: React.FC<PostCreatorProps> = ({ onPostCreated }) => {
    ...
    return (
        <div className="_feed_inner_text_area  _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
            ...
            {imagePreview && (
                <div style={{ position: 'relative', marginTop: 12, borderRadius: 8, overflow: 'hidden', maxHeight: 200 }}>
            ...
            <div className="_feed_inner_text_area_bottom">
                <div className="_feed_inner_text_area_item">
                    ...
                    <div className="_feed_common" style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 6 }}>
                        <button
                            type="button"
                            className="_feed_inner_text_area_bottom_photo_link"
                            onClick={() => setIsPublic(p => !p)}
                            title={isPublic ? 'Visible to everyone — click to make private' : 'Only visible to you — click to make public'}
                            style={{ color: isPublic ? '#1890ff' : '#666' }}
                        >
                            <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img">
                                {isPublic ? (
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24">
                                        <circle cx="12" cy="12" r="10" stroke="#1890FF" strokeWidth="2"/>
                                        <path stroke="#1890FF" strokeWidth="2" d="M2 12h20M12 2a15.3 15.3 0 010 20M12 2a15.3 15.3 0 000 20"/>
                                    </svg>
                                ) : (
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24">
                                        <rect x="3" y="11" width="18" height="11" rx="2" stroke="#666" strokeWidth="2"/>
                                        <path stroke="#666" strokeWidth="2" strokeLinecap="round" d="M7 11V7a5 5 0 0110 0v4"/>
                                    </svg>
                                )}
                            </span>
                ...
                <div className="_feed_inner_text_area_btn">
                    <button
                        ...
                        style={{ opacity: submitting || (!postText.trim() && !selectedImage) ? 0.6 : 1 }}
                    >
