...
import { exploreMenuReducer, initialState } from './ExploreMenu.reducer';
import { clickExploreItem } from './ExploreMenu.actions';

const ExploreMenu: React.FC = () => {
    const [, dispatch] = useReducer(exploreMenuReducer, initialState);

    const handleItemClick = (item: string) => {
        dispatch(clickExploreItem(item));
    };
            ...
            <div className="_left_inner_area_explore _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                ...
                <ul className="_left_inner_area_explore_list">
                    <li className="_left_inner_area_explore_item _explore_item">
                        <a href="#0" className="_left_inner_area_explore_link" onClick={() => handleItemClick('Learning')}>
                    ...
                    <li className="_left_inner_area_explore_item">
                        <a href="#0" className="_left_inner_area_explore_link" onClick={() => handleItemClick('Insights')}>
                    ...
                    <li className="_left_inner_area_explore_item">
                        <a href="find-friends.html" className="_left_inner_area_explore_link" onClick={() => handleItemClick('Find friends')}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
                    ...
                    <li className="_left_inner_area_explore_item">
                        <a href="#0" className="_left_inner_area_explore_link" onClick={() => handleItemClick('Bookmarks')}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
                    ...
                    <li className="_left_inner_area_explore_item">
                        <a href="group.html" className="_left_inner_area_explore_link" onClick={() => handleItemClick('Group')}>
                    ...
                    <li className="_left_inner_area_explore_item">
                        <a href="#0" className="_left_inner_area_explore_link" onClick={() => handleItemClick('Save post')}>
